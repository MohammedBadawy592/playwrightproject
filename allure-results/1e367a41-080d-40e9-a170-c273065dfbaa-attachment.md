...
Expected: true
Received: {"btnSearch": {"_apiName": "Locator", "_frame": {"_guid": "frame@698960483b4f1422f70f106d73c93dfa", "_type": "Frame"}, "_selector": "form>button[type='submit']", Symbol(nodejs.util.inspect.custom): [Function anonymous]}, "lnkLogin": {"_apiName": "Locator", "_frame": {"_guid": "frame@698960483b4f1422f70f106d73c93dfa", "_type": "Frame"}, "_selector": "li>a:has-text(\"Login\")", Symbol(nodejs.util.inspect.custom): [Function anonymous]}, "lnkMyAccount": {"_apiName": "Locator", "_frame": {"_guid": "frame@698960483b4f1422f70f106d73c93dfa", "_type": "Frame"}, "_selector": "span:has-text('My Account')", Symbol(nodejs.util.inspect.custom): [Function anonymous]}, "lnkRegister": {"_apiName": "Locator", "_frame": {"_guid": "frame@698960483b4f1422f70f106d73c93dfa", "_type": "Frame"}, "_selector": ".dropdown li>a:has-text(\"Register\")", Symbol(nodejs.util.inspect.custom): [Function anonymous]}, "page": {"_guid": "page@87153d9492c0097e199f32175ae11cdd", "_type": "Page"}, "txtSearchBox": {"_apiName": "Locator", "_frame": {"_guid": "frame@698960483b4f1422f70f106d73c93dfa", "_type": "Frame"}, "_selector": "input[placeholder=\"Search\"]", Symbol(nodejs.util.inspect.custom): [Function anonymous]}}
```
...
```ts
  ...
  25 | //     await page.close();
  26 | // })
  27 | test('user logout test', async ({ page }) => {
  28 |   await homepage.clickMyAccount();
  29 |   await homepage.ClickLogin();
  30 |   await loginPage.completeLogin(config.email,config.password);
  31 |   await expect(page.locator('div[id="content"] h1')).toBeVisible();
  32 | logout=await myAccount.clickLogout();
> 33 | expect(await logout.clickContinue()).toBe(true);
     |                                      ^ Error: expect(received).toBe(expected) // Object.is equality
  34 | homepage=await logout.clickContinue();  
  35 | expect(await homepage.isHomePageExist()).toBe(true)
  36 | 
  37 | 
  38 | 
  39 | })
